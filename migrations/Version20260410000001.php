    ...
    public function up(Schema $schema): void
    {
        ...
        if ($isPostgres) {
            ...
            $this->addSql('CREATE TABLE "user" (
                ...
                password VARCHAR(255) DEFAULT NULL,
                display_name VARCHAR(255) NOT NULL,
                encrypted_anthropic_api_key CLOB DEFAULT NULL,
        ...
        if ($isPostgres) {
            ...
            $this->addSql('CREATE TABLE recording (
                ...
                status VARCHAR(20) NOT NULL,
                transcription CLOB DEFAULT NULL,
                error_message CLOB DEFAULT NULL,
                created_at DATETIME NOT NULL,
                updated_at DATETIME NOT NULL,
                PRIMARY KEY(id),
                CONSTRAINT FK_BB532B177E3C61F9 FOREIGN KEY (owner_id) REFERENCES "user" (id)
            )');
        }
        ...
        if ($isPostgres) {
            ...
            $this->addSql('CREATE TABLE recording_share (
                ...
                created_at DATETIME NOT NULL,
                PRIMARY KEY(id),
                CONSTRAINT FK_SHARE_RECORDING FOREIGN KEY (recording_id) REFERENCES recording (id),
                CONSTRAINT FK_SHARE_USER FOREIGN KEY (shared_with_id) REFERENCES "user" (id)
            )');
        }
        ...
        if ($isPostgres) {
            ...
            $this->addSql('CREATE TABLE claude_session (
                ...
                PRIMARY KEY(id),
                CONSTRAINT FK_CLAUDE_RECORDING FOREIGN KEY (recording_id) REFERENCES recording (id),
                CONSTRAINT FK_CLAUDE_USER FOREIGN KEY (user_id) REFERENCES "user" (id)
            )');
        }
